...
part of 'books_subcategory_store.dart';
...
mixin _$BooksSubcategoryStore on _BooksSubcategoryStore, Store {
  late final _$subcategoriasAtom =
      Atom(name: '_BooksSubcategoryStore.subcategorias', context: context);
  ...
  late final _$isLoadingAtom =
      Atom(name: '_BooksSubcategoryStore.isLoading', context: context);
  ...
  late final _$errorAtom =
      Atom(name: '_BooksSubcategoryStore.error', context: context);
  ...
  late final _$lastCategoriaIdAtom =
      Atom(name: '_BooksSubcategoryStore.lastCategoriaId', context: context);
  ...
  late final _$fetchSubcategoriasAsyncAction = AsyncAction(
      '_BooksSubcategoryStore.fetchSubcategorias',
      context: context);
