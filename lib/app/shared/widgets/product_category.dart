...
class ProductCategory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectionTap = !isReadOnly && onCheckboxChanged != null
        ? () => onCheckboxChanged!(!isSelected)
        : null;
    final actionTap = onCardTap ?? onActionTap;
...
class _ProductCategoryContent extends StatelessWidget {
  final Widget categoryIcon;
  final String title;
  final String value;
  final int selectedCount;
